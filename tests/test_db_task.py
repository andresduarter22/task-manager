...
class Evaluate(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        mongo = MongoDbConnector("mongo,27017,db_task,test", [data])
        actual = mongo.insert()
        expected = {"response": "Data successfully inserted"}
        self.assertEqual(expected, actual)

    def test_select_all(self):
        mongo = MongoDbConnector("mongo,27017,db_task,test", [])
    ...
    def test_select(self):
        data = {"_id": 2, "First name": "Andres"}
        mongo = MongoDbConnector("mongo,27017,db_task,test", ["2"])
    ...
    def test_update(self):
        ...
        mongo = MongoDbConnector("mongo,27017,db_task,test", ["2", data])
        actual = mongo.update()
        expected = {
